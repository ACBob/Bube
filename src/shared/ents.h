...
struct extentity : entity // part of the entity that doesn't get saved to disk
{
	...
	bool nopickup() const
	{
		return (flags & EF_NOPICKUP) != 0;
	}
	void setnopickup(bool val)
	{
		if (val)
			flags |= EF_NOPICKUP;
		else
...
static const char *const animnames[] = {
	"dead",		 "dying",	   "idle",	   "forward",  "backward", "left",	 "right",	 "hold 1",
	"hold 2",	 "hold 3",	   "hold 4",   "hold 5",   "hold 6",   "hold 7", "attack 1", "attack 2",
	"attack 3",	 "attack 4",   "attack 5", "attack 6", "attack 7", "pain",	 "jump",	 "sink",
	"swim",		 "edit",	   "lag",	   "taunt",	   "win",	   "lose",	 "gun idle", "gun shoot",
	"vwep idle", "vwep shoot", "shield",   "powerup",  "mapmodel", "trigger"};
